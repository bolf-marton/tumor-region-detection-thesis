...
def maskrcnn_training_testing_loop(model:Any, device:str, train_dataloader:torch.utils.data.DataLoader, test_dataloader:torch.utils.data.DataLoader, optimizer:Any, scheduler:Any, n_epochs:int=0, box_score_thresh:float=0.5, comet_logger:CometLogger=None):
...
def unet_training_testing_loop(model:Any, device:str, train_dataloader:torch.utils.data.DataLoader, optimizer:Any, scheduler:Any, n_epochs:int=0, box_score_thresh:float=0.5, comet_logger:CometLogger=None):
    """Training loop for Mask R-CNN.
    Args:
        model (Any): pytorch NN model.
        device (str): "cuda" / "cpu".
